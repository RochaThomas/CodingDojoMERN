...
/*
make a key value pair of letters and occurences
for loop through the string
for loop through the object
check how many odd occurences there are
if more than one for a string of odd length then false
if 1 or more for a string of even length then false
*/
